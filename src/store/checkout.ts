...
export type PaymentMethodName =  'STRIPE' | 'RAZORPAY';
// export type PaymentMethodName =  'RAZORPAY' | 'STRIPE';
// export type PaymentMethodName = 'CASH_ON_DELIVERY' | 'STRIPE' | 'RAZORPAY';
