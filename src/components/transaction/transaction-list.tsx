...
import OrderCard from './transaction-card';
...
export default function OrderList({
  ...
  return (
    <div className="h-[80vh] min-h-[670px] w-full ltr:pr-5 rtl:pl-5 md:w-3/3 md:shrink-0 ltr:lg:pr-8 rtl:lg:pl-8">
