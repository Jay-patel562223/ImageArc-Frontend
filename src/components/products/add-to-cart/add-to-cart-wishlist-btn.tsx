...
const AddToCartWishlistBtn: React.FC<Props> = ({ variant, onClick, disabled }) => {
  ...
  switch (variant) {
    ...
    case 'remove':
      return (
        <button
          onClick={onClick}
          className="whitespace-nowrap text-sm font-semibold text-accent hover:underline sm:mt-0"
          ...
          // )}
          >
          <span className="flex-1">Remove from cart</span>
...
export default AddToCartWishlistBtn;
